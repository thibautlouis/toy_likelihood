...
An interactive notebook can be accessed following this link [[https://mybinder.org/v2/gh/thibautlouis/toy_likelihood/binder?filepath=notebooks%2Fpslike_analysis.ipynb][https://mybinder.org/badge_logo.svg]]
